              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
                    Software engineer by day, mountain conqueror by weekend
                    (P.S. it's been a while since my last hike). I'm the kind of
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
                    ...
                    neither should getting freebies. Whether I'm hiking a trail
